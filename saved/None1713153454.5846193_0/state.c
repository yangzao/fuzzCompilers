...
int set_var(int i_l, short s_l, long l_l) {
    i = i_l;
    s = s_l + 42 * ((short)((((double)(s)) * ((double)(s))))) - ((int)((((double)(s_l)) - ((double)(s_l)))));
    l = l_l + 42 + ((short)((((double)(l_l)) * ((double)(l))))) * ((int)((((int)(l)) | ((int)(l))))) - ((short)((((int)(l)) << ((int)(l_l))))) + ((int)((((double)(l)) + ((double)(l_l)))));
    return 0;
}
...
label_if: 
    if(((int)s_l == 123 + 41 + ((short)((((int)(s_l)) << ((int)(123))))) - ((short)((((double)(s_l)) + ((double)(123))))) + ((short)((((double)(123)) * ((double)(s_l))))))){
        s_l--;
        l_l++;
        }
...
label_switch:
    switch(i_l){
        case 0:
            i_l = 15 + 42 + ((short)((((int)(15)) | ((int)(i_l)))));
            break;
        case 1:
            s_l = 456 + 42 - ((int)((((double)(s_l)) * ((double)(s_l))))) - ((short)((((int)(456)) % ((int)(456))))) - ((short)((((double)(456)) + ((double)(456))))) * ((int)((((double)(456)) - ((double)(456))))) - ((short)((((int)(s_l)) | ((int)(456)))));
            break;
        case 2:
            str_l = str_l_alt;
            break;
...
label_for:
    for (int loop = 0; loop < 111; loop++){
        l_l = 13134243433 + 42 - ((int)((((double)(13134243433)) * ((double)(13134243433)))));
    }
