...
void func_1(){
    ...
    i_l = 1 + 42 * ((long)((((double)(1)) + ((double)(i_l)))));
    goto label_last;

label_while:
    while(i_l == 1){
        s_l = 321 + 42 - ((long)((((int)(s_l)) % ((int)(321))))) + ((int)((((double)(s_l)) + ((double)(s_l))))) - ((short)((((double)(321)) + ((double)(s_l)))));
        i_l++;
        }
  
label_if: 
    if(((int)s_l == 123 + 41 * ((int)((((int)(s_l)) << ((int)(s_l))))) - ((long)((((int)(123)) % ((int)(123))))) - ((int)((((double)(s_l)) - ((double)(s_l))))) * ((short)((((double)(s_l)) + ((double)(123))))))){
        s_l--;
        l_l++;
        }
...
label_switch:
    switch(1){
        case 0:
            i_l = 15 + 42 * ((short)((((double)(15)) - ((double)(15))))) + ((long)((((int)(i_l)) >> ((int)(i_l)))));
            break;
        case 1:
            s_l = 456;
            break;
...
label_for:
    for (int loop = 0; loop < 111; loop++){
        l_l = 13134243433 + 42 - ((long)((((int)(l_l)) >> ((int)(l_l))))) + ((long)((((double)(13134243433)) + ((double)(l_l))))) * ((int)((((double)(l_l)) * ((double)(13134243433))))) + ((long)((((double)(13134243433)) - ((double)(13134243433))))) + ((long)((((int)(13134243433)) >> ((int)(13134243433)))));
    }
