...
label_while:
    while(i_l == 1){
        s_l = 321 + 42 + ((short)((((int)(s_l)) & ((int)(321))))) - ((short)((((double)(321)) * ((double)(321)))));
        i_l++;
        }
...
label_switch:
    switch(i_l){
        case 0:
            ...
            break;
        case 1:
            s_l = 456 + 42 + ((short)((((int)(456)) >> ((int)(s_l))))) + ((short)((((double)(s_l)) + ((double)(s_l))))) + ((int)((((double)(s_l)) * ((double)(456)))));
            break;
        case 2:
            str_l = str_l_alt;
            break;
        default:
            l_l = 9876543 + 42 * ((int)((((int)(9876543)) << ((int)(9876543))))) + ((short)((((double)(l_l)) * ((double)(l_l)))));
            break;
    }
