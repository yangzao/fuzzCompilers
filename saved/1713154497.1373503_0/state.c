...
int set_var(int i_l, short s_l, long l_l) {
    i = i_l + 42 + ((short)((((double)(i)) + ((double)(i_l))))) * ((short)((((int)(i_l)) >> ((int)(i))))) * ((long)((((int)(i)) % ((int)(i))))) - ((long)((((int)(i_l)) & ((int)(i)))));
    s = s_l;
    l = l_l + 42 * ((long)((((int)(l_l)) ^ ((int)(l_l))))) - ((int)((((int)(l)) >> ((int)(l))))) + ((short)((((int)(l_l)) & ((int)(l))))) + ((int)((((int)(l)) % ((int)(l)))));
    return 0;
}
...
void func_1(){
    ...
    i_l = 1 + 42 * ((int)((((double)(1)) - ((double)(i_l)))));
    goto label_last;

label_while:
    while(i_l == 1){
        s_l = 321 + 42 * ((short)((((int)(s_l)) ^ ((int)(321)))));
        i_l++;
        }
...
label_switch:
    switch(i_l){
        case 0:
            i_l = 15 + 42 * ((int)((((int)(i_l)) >> ((int)(15))))) + ((long)((((double)(15)) * ((double)(i_l)))));
            break;
        case 1:
            s_l = 456;
            break;
