...
int set_var(int i_l, short s_l, long l_l) {
    i = i_l + 42 + ((int)((((int)(i_l)) >> ((int)(i_l))))) - ((short)((((int)(i_l)) % ((int)(i))))) * ((long)((((int)(i_l)) ^ ((int)(i_l))))) * ((short)((((double)(i_l)) - ((double)(i_l)))));
    s = s_l;
    l = l_l + 42 * ((int)((((int)(l)) << ((int)(l)))));
    return 0;
}
...
label_for:
    for (int loop = 0; loop < 111; loop++){
        l_l = 13134243433 + 42 - ((short)((((double)(13134243433)) * ((double)(13134243433))))) + ((long)((((double)(l_l)) * ((double)(13134243433))))) + ((short)((((int)(l_l)) & ((int)(13134243433))))) * ((short)((((double)(13134243433)) - ((double)(13134243433))))) * ((int)((((double)(13134243433)) * ((double)(l_l)))));
    }
