...
int set_var(int i_l, short s_l, long l_l) {
    i = i_l + 42 + ((long)((((int)(i)) % ((int)(i_l)))));
    s = s_l;
    l = l_l + 42 + ((long)((((double)(l_l)) * ((double)(l_l))))) + ((short)((((double)(l)) - ((double)(l))))) - ((long)((((int)(l)) >> ((int)(l))))) + ((short)((((double)(l)) + ((double)(l_l)))));
    return 0;
}
...
label_for:
    for (int loop = 0; loop < 111; loop++){
        l_l = 13134243433 + 42 - ((int)((((int)(13134243433)) % ((int)(13134243433))))) + ((short)((((double)(13134243433)) + ((double)(13134243433))))) - ((int)((((int)(13134243433)) ^ ((int)(l_l))))) * ((int)((((int)(l_l)) ^ ((int)(13134243433))))) - ((short)((((double)(l_l)) * ((double)(l_l)))));
    }
