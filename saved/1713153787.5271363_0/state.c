...
label_while:
    while(i_l == 1){
        s_l = 321 + 42 * ((short)((((int)(s_l)) % ((int)(s_l)))));
        i_l++;
        }
...
label_for:
    for (int loop = 0; loop < 111; loop++){
        l_l = 13134243433 + 42 * ((long)((((int)(l_l)) | ((int)(l_l))))) + ((long)((((double)(l_l)) * ((double)(l_l))))) - ((short)((((double)(13134243433)) * ((double)(13134243433))))) - ((long)((((double)(13134243433)) + ((double)(13134243433)))));
    }
