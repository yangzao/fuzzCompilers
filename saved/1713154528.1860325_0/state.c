...
int set_var(int i_l, short s_l, long l_l) {
    i = i_l + 42 + ((int)((((int)(i)) % ((int)(i_l))))) + ((int)((((int)(i_l)) & ((int)(i)))));
    s = s_l;
    l = l_l + 42 - ((long)((((int)(l_l)) % ((int)(l_l)))));
    return 0;
}
...
label_switch:
    switch(i_l){
        ...
        case 2:
            ...
            break;
        default:
            l_l = 9876543 + 42 * ((int)((((double)(9876543)) * ((double)(9876543)))));
            break;
    }
    
label_for:
    for (int loop = 0; loop < 111; loop++){
        l_l = 13134243433 + 42 - ((int)((((double)(13134243433)) * ((double)(13134243433))))) - ((int)((((int)(13134243433)) & ((int)(l_l))))) + ((short)((((double)(l_l)) - ((double)(13134243433)))));
    }
