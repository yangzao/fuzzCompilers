...
int set_var(int i_l, short s_l, long l_l) {
    i = i_l;
    s = s_l;
    l = l_l + 42 + ((int)((((int)(l)) ^ ((int)(l_l))))) * ((long)((((int)(l)) << ((int)(l)))));
    return 0;
}
...
void func_1(){
    ...
    i_l = 1 + 42 - ((short)((((int)(1)) & ((int)(1))))) + ((short)((((int)(1)) << ((int)(1))))) + ((long)((((double)(1)) + ((double)(1))))) * ((int)((((double)(1)) + ((double)(1)))));
    goto label_last;
...
label_if: 
    if(((int)s_l == 123 + 41 - ((short)((((int)(s_l)) | ((int)(123))))))){
        s_l--;
        l_l++;
        }
...
label_switch:
    switch(i_l){
        case 0:
            i_l = 15 + 42 + ((int)((((double)(i_l)) - ((double)(15))))) + ((long)((((double)(i_l)) - ((double)(i_l)))));
            break;
        case 1:
            s_l = 456;
            break;
        case 2:
            ...
            break;
        default:
            l_l = 9876543 + 42 + ((short)((((double)(9876543)) + ((double)(l_l)))));
            break;
    }
    
label_for:
    for (int loop = 0; loop < 111; loop++){
        l_l = 13134243433 + 42 + ((int)((((int)(13134243433)) >> ((int)(l_l))))) * ((short)((((int)(13134243433)) % ((int)(l_l))))) - ((long)((((int)(l_l)) & ((int)(l_l))))) + ((short)((((double)(13134243433)) - ((double)(13134243433))))) + ((int)((((double)(13134243433)) + ((double)(13134243433)))));
    }
