...
int set_var(int i_l, short s_l, long l_l) {
    i = i_l + 42 + ((short)((((double)(i)) + ((double)(i))))) + ((int)((((double)(i_l)) * ((double)(i))))) + ((short)((((double)(i_l)) - ((double)(i)))));
    s = s_l;
    l = l_l + 42 - ((long)((((int)(l)) << ((int)(l_l))))) + ((int)((((int)(l)) << ((int)(l_l))))) + ((short)((((int)(l)) << ((int)(l_l))))) + ((long)((((int)(l)) >> ((int)(l))))) + ((short)((((int)(l)) ^ ((int)(l_l)))));
    return 0;
}
