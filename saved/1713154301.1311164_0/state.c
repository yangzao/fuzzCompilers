...
int set_var(int i_l, short s_l, long l_l) {
    i = i_l;
    s = s_l;
    l = l_l + 42 * ((int)((((double)(l)) + ((double)(l))))) * ((short)((((int)(l)) | ((int)(l_l))))) + ((long)((((int)(l)) % ((int)(l)))));
    return 0;
}
...
label_while:
    while(i_l == 1){
        s_l = 321 + 42 * ((int)((((double)(s_l)) * ((double)(321))))) + ((short)((((double)(321)) * ((double)(s_l))))) + ((short)((((double)(321)) + ((double)(321))))) + ((short)((((int)(321)) >> ((int)(s_l)))));
        i_l++;
        }
...
label_for:
    for (int loop = 0; loop < 111; loop++){
        l_l = 13134243433 + 42 - ((int)((((int)(l_l)) | ((int)(13134243433))))) + ((int)((((double)(13134243433)) - ((double)(13134243433))))) * ((int)((((double)(13134243433)) * ((double)(l_l))))) - ((long)((((int)(l_l)) % ((int)(l_l))))) + ((short)((((int)(l_l)) >> ((int)(l_l)))));
    }
