...
int set_var(int i_l, short s_l, long l_l) {
    ...
    s = s_l;
    l = l_l + 42 + ((short)((((double)(l)) * ((double)(l))))) - ((int)((((double)(l)) + ((double)(l_l))))) - ((int)((((double)(l)) * ((double)(l_l))))) + ((long)((((int)(l_l)) << ((int)(l))))) + ((long)((((int)(l_l)) | ((int)(l_l)))));
    return 0;
}
...
label_switch:
    switch(i_l){
        case 0:
            i_l = 15 + 42 * ((int)((((int)(15)) % ((int)(15))))) * ((short)((((int)(15)) % ((int)(15)))));
            break;
        case 1:
            s_l = 456;
            break;
