...
int set_var(int i_l, short s_l, long l_l) {
    i = i_l + 42 + ((short)((((int)(i_l)) | ((int)(i_l))))) * ((long)((((int)(i)) | ((int)(i_l))))) + ((int)((((int)(i)) % ((int)(i))))) + ((long)((((double)(i_l)) + ((double)(i_l))))) * ((int)((((int)(i_l)) ^ ((int)(i_l)))));
    s = s_l;
    l = l_l;
    return 0;
}
...
label_if: 
    if(((int)s_l == 123 + 41 * ((long)((((double)(s_l)) * ((double)(123))))) * ((int)((((double)(s_l)) + ((double)(123))))))){
        s_l--;
        l_l++;
        }
...
label_for:
    for (int loop = 0; loop < 111; loop++){
        l_l = 13134243433 + 42 + ((short)((((int)(13134243433)) ^ ((int)(l_l))))) * ((long)((((double)(l_l)) * ((double)(l_l))))) - ((int)((((double)(l_l)) - ((double)(13134243433))))) - ((int)((((int)(l_l)) >> ((int)(l_l))))) * ((short)((((double)(13134243433)) * ((double)(13134243433)))));
    }
