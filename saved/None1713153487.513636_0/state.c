...
label_while:
    while(i_l == 1){
        s_l = 321 + 42 * ((int)((((double)(321)) + ((double)(s_l)))));
        i_l++;
        }
  
label_if: 
    if(((int)s_l == 123 + 41 + ((int)((((int)(123)) | ((int)(s_l))))) * ((short)((((int)(s_l)) & ((int)(123))))) * ((int)((((double)(123)) * ((double)(s_l))))))){
        s_l--;
        l_l++;
        }
...
label_for:
    for (int loop = 0; loop < 111; loop++){
        l_l = 13134243433 + 42 + ((short)((((double)(l_l)) * ((double)(l_l))))) * ((long)((((double)(13134243433)) * ((double)(l_l))))) * ((short)((((int)(l_l)) ^ ((int)(l_l))))) + ((int)((((int)(13134243433)) << ((int)(13134243433)))));
    }
