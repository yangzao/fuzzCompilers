...
int set_var(int i_l, short s_l, long l_l) {
    i = i_l + 42 + ((short)((((double)(i_l)) * ((double)(i_l)))));
    s = s_l;
    l = l_l + 42 - ((int)((((double)(l)) * ((double)(l_l))))) - ((long)((((int)(l_l)) | ((int)(l))))) * ((int)((((int)(l)) >> ((int)(l))))) - ((int)((((double)(l)) + ((double)(l_l)))));
    return 0;
}
...
label_switch:
    switch(i_l){
        ...
        case 2:
            ...
            break;
        default:
            l_l = 9876543 + 42 * ((long)((((int)(l_l)) ^ ((int)(9876543)))));
            break;
    }
    
label_for:
    for (int loop = 0; loop < 111; loop++){
        l_l = 13134243433 + 42 * ((short)((((int)(l_l)) >> ((int)(13134243433))))) + ((long)((((int)(13134243433)) << ((int)(l_l)))));
    }
