...
int set_var(int i_l, short s_l, long l_l) {
    i = i_l;
    s = s_l + 42 * ((int)((((double)(s_l)) * ((double)(s)))));
    l = l_l + 42 + ((long)((((double)(l)) + ((double)(l))))) - ((int)((((int)(l_l)) ^ ((int)(l_l))))) - ((long)((((double)(l)) + ((double)(l))))) + ((int)((((int)(l)) >> ((int)(l))))) * ((long)((((int)(l)) % ((int)(l_l)))));
    return 0;
}
...
void func_1(){
    ...
    i_l = 1 + 42 + ((int)((((int)(i_l)) | ((int)(i_l))))) * ((long)((((double)(i_l)) * ((double)(1))))) - ((int)((((double)(1)) + ((double)(1)))));
    goto label_last;
...
label_if: 
    if(((int)s_l == 123 + 41 + ((short)((((int)(123)) & ((int)(123))))) - ((short)((((int)(s_l)) << ((int)(123))))))){
        s_l--;
        l_l++;
        }
