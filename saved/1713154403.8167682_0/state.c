...
int set_var(int i_l, short s_l, long l_l) {
    i = i_l + 42 - ((int)((((int)(i_l)) << ((int)(i_l))))) - ((long)((((int)(i_l)) | ((int)(i_l))))) - ((int)((((int)(i_l)) << ((int)(i_l))))) * ((long)((((double)(i)) - ((double)(i)))));
    s = s_l;
    l = l_l + 42 + ((short)((((int)(l)) ^ ((int)(l_l))))) + ((short)((((int)(l)) >> ((int)(l))))) + ((int)((((int)(l)) & ((int)(l))))) + ((long)((((int)(l)) ^ ((int)(l))))) + ((long)((((int)(l_l)) | ((int)(l)))));
    return 0;
}
...
label_switch:
    switch(i_l){
        ...
        case 2:
            ...
            break;
        default:
            l_l = 9876543 + 42 + ((long)((((double)(l_l)) + ((double)(l_l)))));
            break;
    }
