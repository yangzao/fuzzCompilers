...
;l = l_l;
l = l_l + 42 + ((long)((((int)(l_l)) >> ((int)(l_l))))) + ((int)((((int)(l_l)) << ((int)(l))))) + ((int)((((double)(l)) + ((double)(l))))) + ((long)((((double)(l)) - ((double)(l))))) - ((short)((((int)(l_l)) ^ ((int)(l_l)))));
    return 0;
}
...
;i_l = 15 + 42 - ((short)((((double)(i_l)) - ((double)(i_l))))) * ((int)((((double)(i_l)) + ((double)(15))))) * ((long)((((int)(i_l)) % ((int)(i_l))))) + ((int)((((double)(i_l)) * ((double)(15))))) - ((short)((((int)(15)) % ((int)(i_l)))));
i_l = 15 + 42 - ((int)((((int)(i_l)) >> ((int)(i_l))))) - ((short)((((int)(i_l)) & ((int)(i_l))))) * ((int)((((double)(i_l)) - ((double)(15))))) * ((short)((((double)(i_l)) - ((double)(i_l)))));
            break;
        case 1:
            
;s_l = 456;
s_l = 456 + 42 + ((short)((((double)(456)) * ((double)(s_l)))));
            break;
        case 2:
