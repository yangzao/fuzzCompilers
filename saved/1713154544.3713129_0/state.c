...
void func_1(){
    ...
    i_l = 1 + 42 * ((int)((((int)(1)) << ((int)(1))))) - ((long)((((int)(i_l)) & ((int)(i_l))))) * ((long)((((double)(1)) - ((double)(i_l))))) - ((short)((((double)(1)) + ((double)(1)))));
    goto label_last;
...
label_switch:
    switch(i_l){
        case 0:
            ...
            break;
        case 1:
            s_l = 456 + 42 * ((short)((((int)(456)) % ((int)(s_l))))) * ((int)((((double)(456)) - ((double)(456))))) * ((long)((((int)(s_l)) % ((int)(s_l)))));
            break;
        case 2:
            str_l = str_l_alt;
            break;
...
label_for:
    for (int loop = 0; loop < 111; loop++){
        l_l = 13134243433 + 42 + ((int)((((double)(13134243433)) + ((double)(13134243433))))) - ((short)((((int)(l_l)) | ((int)(l_l))))) * ((long)((((int)(13134243433)) % ((int)(l_l))))) + ((short)((((double)(l_l)) + ((double)(13134243433))))) + ((int)((((double)(l_l)) + ((double)(l_l)))));
    }
