...
int set_var(int i_l, short s_l, long l_l) {
    i = i_l + 42 - ((short)((((int)(i)) & ((int)(i)))));
    s = s_l;
    l = l_l + 42 * ((short)((((double)(l)) + ((double)(l))))) + ((int)((((double)(l_l)) + ((double)(l_l))))) - ((short)((((int)(l)) >> ((int)(l))))) - ((long)((((double)(l_l)) + ((double)(l_l)))));
    return 0;
}
...
void func_1(){
    ...
    i_l = 1 + 42 + ((long)((((double)(i_l)) + ((double)(i_l))))) + ((int)((((int)(1)) >> ((int)(1)))));
    goto label_last;
...
label_switch:
    switch(i_l){
        case 0:
            i_l = 15 + 42 - ((short)((((int)(i_l)) % ((int)(15))))) * ((short)((((double)(15)) + ((double)(15)))));
            break;
        case 1:
            s_l = 456 + 42 + ((long)((((int)(s_l)) % ((int)(s_l)))));
            break;
        case 2:
            str_l = str_l_alt;
            break;
...
label_for:
    for (int loop = 0; loop < 111; loop++){
        l_l = 13134243433 + 42 * ((long)((((int)(l_l)) | ((int)(13134243433))))) + ((short)((((int)(l_l)) % ((int)(13134243433)))));
    }
