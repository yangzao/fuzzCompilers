...
int set_var(int i_l, short s_l, long l_l) {
    i = i_l + 42 * ((short)((((double)(i_l)) - ((double)(i)))));
    s = s_l;
    l = l_l;
    return 0;
}
...
label_while:
    while(i_l == 1){
        s_l = 321 + 42 * ((int)((((double)(s_l)) * ((double)(321)))));
        i_l++;
        }
...
label_switch:
    switch(i_l){
        case 0:
            i_l = 15 + 42 + ((long)((((double)(i_l)) - ((double)(i_l)))));
            break;
        case 1:
            s_l = 456 + 42 + ((long)((((int)(456)) % ((int)(456))))) + ((long)((((double)(456)) + ((double)(s_l)))));
            break;
        case 2:
            str_l = str_l_alt;
            break;
...
label_for:
    for (int loop = 0; loop < 111; loop++){
        l_l = 13134243433 + 42 * ((int)((((double)(13134243433)) - ((double)(l_l))))) + ((short)((((int)(13134243433)) << ((int)(13134243433))))) - ((long)((((int)(13134243433)) & ((int)(13134243433))))) + ((long)((((int)(13134243433)) ^ ((int)(13134243433)))));
    }
