...
int set_var(int i_l, short s_l, long l_l) {
    i = i_l;
    s = s_l + 42 - ((int)((((int)(s)) & ((int)(s_l))))) * ((long)((((int)(s)) & ((int)(s))))) * ((int)((((double)(s)) - ((double)(s)))));
    l = l_l;
    return 0;
}
...
label_if: 
    if(((int)s_l == 123 + 41 * ((short)((((double)(s_l)) + ((double)(123))))) + ((long)((((int)(123)) % ((int)(123))))))){
        s_l--;
        l_l++;
        }
...
label_switch:
    switch(i_l){
        ...
        case 2:
            ...
            break;
        default:
            l_l = 9876543 + 42 * ((long)((((double)(l_l)) - ((double)(9876543))))) * ((long)((((int)(l_l)) << ((int)(l_l))))) + ((long)((((int)(l_l)) << ((int)(l_l)))));
            break;
    }
    
label_for:
    for (int loop = 0; loop < 111; loop++){
        l_l = 13134243433 + 42 + ((short)((((double)(l_l)) + ((double)(13134243433))))) - ((short)((((int)(13134243433)) >> ((int)(13134243433))))) * ((short)((((int)(13134243433)) >> ((int)(13134243433)))));
    }
