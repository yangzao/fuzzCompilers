...
int set_var(int i_l, short s_l, long l_l) {
    i = i_l + 42 + ((int)((((double)(i)) - ((double)(i_l))))) - ((int)((((double)(i_l)) + ((double)(i_l))))) - ((int)((((int)(i_l)) % ((int)(i))))) - ((short)((((double)(i)) + ((double)(i)))));
    s = s_l + 42 + ((int)((((int)(s)) << ((int)(s_l))))) * ((long)((((int)(s_l)) | ((int)(s_l)))));
    l = l_l;
    return 0;
}
...
label_switch:
    switch(i_l){
        case 0:
            ...
            break;
        case 1:
            s_l = 456 + 42 * ((short)((((double)(s_l)) * ((double)(s_l))))) - ((long)((((double)(456)) + ((double)(456))))) - ((int)((((int)(s_l)) << ((int)(456))))) * ((int)((((double)(s_l)) + ((double)(456)))));
            break;
        case 2:
            str_l = str_l_alt;
            break;
...
label_for:
    for (int loop = 0; loop < 111; loop++){
        l_l = 13134243433 + 42 * ((short)((((double)(13134243433)) * ((double)(13134243433))))) + ((int)((((int)(13134243433)) & ((int)(13134243433))))) * ((short)((((int)(l_l)) & ((int)(l_l))))) * ((int)((((int)(l_l)) >> ((int)(l_l)))));
    }
