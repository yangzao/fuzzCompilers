...
int set_var(int i_l, short s_l, long l_l) {
    i = i_l;
    s = s_l + 42 - ((short)((((double)(s)) * ((double)(s))))) + ((int)((((double)(s)) * ((double)(s))))) - ((long)((((int)(s_l)) & ((int)(s_l))))) + ((short)((((double)(s)) * ((double)(s_l))))) - ((int)((((double)(s)) - ((double)(s)))));
    l = l_l + 42 + ((long)((((int)(l_l)) ^ ((int)(l_l))))) * ((long)((((double)(l_l)) - ((double)(l))))) - ((int)((((double)(l_l)) + ((double)(l)))));
    return 0;
}
...
void func_1(){
    ...
    i_l = 1 + 42 - ((short)((((double)(1)) * ((double)(1)))));
    goto label_last;
...
label_switch:
    switch(i_l){
        case 0:
            ...
            break;
        case 1:
            s_l = 456 + 42 + ((short)((((double)(s_l)) - ((double)(s_l))))) - ((int)((((double)(456)) * ((double)(s_l)))));
            break;
        case 2:
            str_l = str_l_alt;
            break;
...
label_for:
    for (int loop = 0; loop < 111; loop++){
        l_l = 13134243433 + 42 + ((long)((((int)(l_l)) % ((int)(13134243433))))) + ((long)((((int)(l_l)) >> ((int)(13134243433))))) - ((long)((((int)(l_l)) >> ((int)(l_l))))) - ((int)((((double)(l_l)) * ((double)(l_l)))));
    }
