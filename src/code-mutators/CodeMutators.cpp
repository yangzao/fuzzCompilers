...
extern "C"{
  void src_code_mutation(uint8_t *buf, size_t buf_size, char *pointer){
    ...
    const vector<string> no_warning_flag = {"--no-warnings", "-x", "c", "-I/usr/local/lib/clang/18/", "-I/usr/local/lib/clang/18/include", "-I/usr/lib/clang/18/include/", "-I/usr/local/include/", "-I/usr/include/x86_64-linux-gnu/", "-I/usr/include/", "-I/usr/include/linux/"};
